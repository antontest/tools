...
export LIBRARY_PATH=$LIBRARY_PATH:$HOME/etc/clang/lib
#增加.so搜索路径
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$HOME/usr/lib
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$HOME/etc/clang/lib
#增加GCC的include文件搜索路径
export C_INCLUDE_PATH=$C_INCLUDE_PATH:$HOME/usr/include 
export C_INCLUDE_PATH=$C_INCLUDE_PATH:$HOME/etc/clang/include 

#增加cscope文件搜索路径
#export CSCOPE_DB=./cscope.out;/usr/include/cscope.out;/home/anton/tools/include/cscope.out

# 可执行文件路径
export PATH=$PATH:$HOME/etc/clang/bin
...
alias ...='cd ../..'
alias cp='cp -r'
alias int='sudo apt-get install'
